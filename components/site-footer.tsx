...
export function SiteFooter() {
  return <footer className="relative overflow-hidden bg-[#151210] text-white">
    ...
    <div className="relative mx-auto max-w-[1280px] px-5 pb-7 pt-16 lg:px-8 lg:pt-20">
      ...
      <div className="mt-16 flex flex-col justify-between gap-5 border-t border-white/[.11] py-7 text-[12px] text-white/[.44] sm:flex-row sm:items-center"><p>© {new Date().getFullYear()} FreshStart PH. All rights reserved.</p><div className="flex items-center gap-2"><span className="size-1.5 rounded-full bg-[#ff6b35]" aria-hidden="true" /><span>Design, development, and thoughtful digital growth.</span></div></div>
    </div>
  </footer>;
}
